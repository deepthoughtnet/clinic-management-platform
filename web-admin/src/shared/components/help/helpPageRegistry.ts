...
export const HELP_PAGE_ROUTES: HelpPageRoute[] = [
  ...
  { path: "/platform/integrations", pageKey: "PLATFORM_ADMIN", cmsPageKey: "PLATFORM_ADMIN", title: "Platform Admin" },
  { path: "/platform/ai-ops", pageKey: "PLATFORM_ADMIN", cmsPageKey: "PLATFORM_ADMIN", title: "Platform Admin" },
  { path: "/platform/ai-reasoning-console", pageKey: "PLATFORM_ADMIN", cmsPageKey: "PLATFORM_ADMIN", title: "Platform Admin" },
  { path: "/platform/operations", pageKey: "PLATFORM_ADMIN", cmsPageKey: "PLATFORM_ADMIN", title: "Platform Admin" },
  { path: "/platform/realtime-ai", pageKey: "PLATFORM_ADMIN", cmsPageKey: "PLATFORM_ADMIN", title: "Platform Admin" },
  { path: "/platform/voice-test", pageKey: "PLATFORM_ADMIN", cmsPageKey: "PLATFORM_ADMIN", title: "Platform Admin" },
