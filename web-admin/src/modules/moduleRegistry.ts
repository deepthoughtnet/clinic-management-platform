...
export const MODULE_REGISTRY: Record<TenantModuleCode, ModuleDefinition> = {
  ...
  PRESCRIPTION: {
    ...
    navigationEntries: ["prescriptions", "dispensing"],
  ...
  INVENTORY: {
    ...
    navigationEntries: ["pharmacy-dashboard", "prescription-register", "dispensing", "pharmacy-pos", "medicine-master", "inventory", "pharmacy-procurement", "pharmacy-reconciliation", "stock-movements"],
