...
export const NAV_GROUPS: NavGroup[] = [
  ...
  {
    key: "platform-ai-operations",
    label: "AI Operations",
    platformOnly: true,
    defaultExpanded: true,
    items: [
      { key: "ai-ops", label: "AI Ops", path: "/platform/ai-ops", platformOnly: true },
      { key: "ai-reasoning-console", label: "AI Reasoning Console", path: "/platform/ai-reasoning-console", platformOnly: true },
      { key: "realtime-ai", label: "Realtime AI", path: "/platform/realtime-ai", platformOnly: true },
      { key: "voice-test", label: "Voice Test", path: "/platform/voice-test", platformOnly: true },
    ],
  },
  {
    ...
    defaultExpanded: false,
    items: [
      { key: "platform-ops", label: "Platform Ops", path: "/platform/operations", platformOnly: true },
