...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    rolesAny: ["CLINIC_ADMIN", "AUDITOR"],
    items: [
      { key: "campaigns", label: "Campaigns", path: "/carepilot/campaigns", requiresTenant: true, rolesAny: ["CLINIC_ADMIN", "AUDITOR"] },
      { key: "messaging", label: "Messaging", disabled: true, future: true, badge: "Coming soon", requiresTenant: true, rolesAny: ["CLINIC_ADMIN"] },
      { key: "reminders", label: "Reminders", disabled: true, future: true, badge: "Coming soon", requiresTenant: true, rolesAny: ["CLINIC_ADMIN"] },
      { key: "patient-engagement", label: "Patient Engagement", disabled: true, future: true, badge: "Coming soon", requiresTenant: true, rolesAny: ["CLINIC_ADMIN"] },
      { key: "leads", label: "Leads", disabled: true, future: true, badge: "Coming soon", requiresTenant: true, rolesAny: ["CLINIC_ADMIN"] },
