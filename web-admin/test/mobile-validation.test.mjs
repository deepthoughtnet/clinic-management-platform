...
test("admin mobile forms use the shared normalization helper", () => {
  ...
  const leadHelpers = readSource("products/carepilot/leads/leadFormUtils.js");
  ...
  for (const source of [patientForm, appointments, leadHelpers, messaging, aiCalls, webinars, pharmacyOps, pharmacyPos]) {
