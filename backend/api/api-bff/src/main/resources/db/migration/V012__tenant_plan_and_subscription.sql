...
values
    ('FREE', 'FREE', 'Free', 'Free starter plan', 5, 2, 200, now(), '{}'::jsonb),
    ('PRO', 'PRO', 'Pro', 'Professional clinic plan', 100, 30, 20000, now(), '{}'::jsonb)
on conflict (id) do update set
    ...
    created_at = coalesce(tenant_plans.created_at, excluded.created_at);
