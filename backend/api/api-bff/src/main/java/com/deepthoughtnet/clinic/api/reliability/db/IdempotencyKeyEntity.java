...
@Table(name = "idempotency_keys", indexes = {
        ...
        @UniqueConstraint(name = "uq_idempotency_keys_tenant_idempotency_key", columnNames = {"tenant_id", "idempotency_key"})
})
public class IdempotencyKeyEntity {
    ...
    public static IdempotencyKeyEntity create(UUID tenantId, String idempotencyKey, String requestHash, String responseJson) {
