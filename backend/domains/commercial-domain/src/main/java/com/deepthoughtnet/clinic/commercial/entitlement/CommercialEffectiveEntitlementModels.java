...
public final class CommercialEffectiveEntitlementModels {
    private CommercialEffectiveEntitlementModels() {
    }
    ...
    public record CapabilityResponse(
            ...
            String name,
            boolean enabled,
            CommercialEffectiveEntitlementEnums.SourceType source,
            String reason
    ) {
    }
    ...
    public record AddOnContributionResponse(
            String code,
            String name,
            CommercialEffectiveEntitlementEnums.AddOnEffectiveState state,
            CommercialEffectiveEntitlementEnums.SourceType source,
            List<String> appliedContributions
    ) {
    }
    ...
    public record ComparisonItemResponse(
            String code,
            String label,
            CommercialEffectiveEntitlementEnums.ComparisonCategory category,
            String legacyValue,
    ...
    public record LegacyComparisonResponse(
            UUID tenantId,
            List<ComparisonItemResponse> modules,
            List<ComparisonItemResponse> features,
            List<ComparisonItemResponse> limits
    ) {
    }

    public record CreateOverrideRequest(
            CommercialEffectiveEntitlementEnums.OverrideTargetType targetType,
            String targetCode,
            CommercialEffectiveEntitlementEnums.OverrideOperation operation,
            String value,
            String addOnState,
            LocalDate effectiveFrom,
            LocalDate effectiveUntil,
    ...
    public record RuntimeDiffDashboardResponse(
            RuntimeDiffSummaryResponse summary,
            List<RuntimeDiffTenantResponse> tenants
    ) {
    }
}
