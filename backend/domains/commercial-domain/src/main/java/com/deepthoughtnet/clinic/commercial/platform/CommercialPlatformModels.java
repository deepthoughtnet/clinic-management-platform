...
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.DraftStatus;
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.PublicationStatus;
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.SelectionSource;
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.SelectionState;
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.TargetSegment;
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.TemplateStatus;
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.ValidationState;
import static com.deepthoughtnet.clinic.commercial.platform.CommercialPlatformEnums.ValidationSeverity;

public final class CommercialPlatformModels {
    private CommercialPlatformModels() {
    }
    ...
    public record SelectedCapability(UUID capabilityId, String capabilityCode, String capabilityName, String description, int displayOrder, boolean retired) {
    }

    public record SelectedModule(UUID moduleId, String moduleCode, String moduleName, String description, String runtimeModuleCode, int displayOrder, boolean inherited, SelectionSource selectionSource, boolean retired) {
    }

    public record SelectedFeature(UUID featureId, String featureCode, String featureName, String description, UUID moduleId, String moduleCode, String moduleName, int displayOrder, boolean retired) {
    }

    public record SelectedLimit(UUID limitDefinitionId, String limitCode, String limitName, String description, String unit, LimitValueType valueType, AggregationPeriod aggregationPeriod, EnforcementMode enforcementMode, String configuredValue, int displayOrder, boolean retired) {
    }

    public record SelectedAddon(UUID addonId, String addonCode, String addonName, String description, AddonType addonType, int displayOrder, SelectionState selectionState, boolean retired) {
    }

    public record PlanConfigurationSnapshot(
            String templateCode,
            String templateName,
            ...
            Integer displayOrder,
            List<SelectedCapability> capabilities,
            List<SelectedModule> modules,
            List<SelectedFeature> features,
            List<SelectedLimit> limits,
            List<SelectedAddon> addons,
            PlanPricingSnapshot pricing
    ) {
        public PlanConfigurationSnapshot(String templateCode, String templateName, String templateDescription, TargetSegment targetSegment, TemplateStatus templateStatus, Integer displayOrder, List<SelectedCapability> capabilities, List<SelectedModule> modules, List<SelectedFeature> features, List<SelectedLimit> limits, List<SelectedAddon> addons) {
            this(templateCode, templateName, templateDescription, targetSegment, templateStatus, displayOrder, capabilities, modules, features, limits, addons, new PlanPricingSnapshot(null, null, null, null, null, null, null, null, false, List.of(), List.of()));
        }
    }
}
