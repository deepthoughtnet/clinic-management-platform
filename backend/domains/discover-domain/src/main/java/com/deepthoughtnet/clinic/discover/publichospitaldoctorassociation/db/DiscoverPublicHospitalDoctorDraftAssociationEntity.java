...
@Entity
@Table(
        name = "discover_public_hospital_doctor_draft_associations",
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uq_discover_public_hospital_doctor_draft_associations_natural_key",
                        columnNames = {"source_system", "source_hospital_reference", "source_doctor_reference"}
                )
        }
)
public class DiscoverPublicHospitalDoctorDraftAssociationEntity {
    @Id
    ...
    protected DiscoverPublicHospitalDoctorDraftAssociationEntity() {
    }

    public static DiscoverPublicHospitalDoctorDraftAssociationEntity create(
        ...
        DiscoverPublicHospitalDoctorDraftAssociationEntity entity = new DiscoverPublicHospitalDoctorDraftAssociationEntity();
