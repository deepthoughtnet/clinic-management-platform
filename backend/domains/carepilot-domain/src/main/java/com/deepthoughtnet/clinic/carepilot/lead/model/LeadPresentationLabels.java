...
public final class LeadPresentationLabels {
    ...
    private static final Map<LeadActivityType, String> ACTIVITY_LABELS = Map.ofEntries(
            ...
            Map.entry(LeadActivityType.WEBINAR_REGISTERED, "Webinar Registered"),
            Map.entry(LeadActivityType.WEBINAR_ATTENDED, "Webinar Attended"),
            Map.entry(LeadActivityType.WEBINAR_NO_SHOW, "Webinar No-show"),
            Map.entry(LeadActivityType.WEBINAR_REGISTRATION_CANCELLED, "Webinar Registration Cancelled"),
