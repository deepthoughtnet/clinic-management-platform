...
public final class RolePermissionMappings {
    ...
    private static final Set<String> PLATFORM_ADMIN_BASE_PERMISSIONS = Set.of(
            ...
            Permissions.COMMERCIAL_OVERRIDES_CREATE,
            Permissions.COMMERCIAL_OVERRIDES_SUBMIT,
            Permissions.COMMERCIAL_OVERRIDES_REVIEW,
            Permissions.COMMERCIAL_OVERRIDES_ACTIVATE,
            Permissions.COMMERCIAL_OVERRIDES_CANCEL,
            Permissions.COMMERCIAL_OVERRIDES_ROLLBACK,
            Permissions.COMMERCIAL_OVERRIDES_MANAGE,
            Permissions.COMMERCIAL_RUNTIME_DIAGNOSTICS_VIEW,
            Permissions.COMMERCIAL_RUNTIME_READINESS_VIEW,
            Permissions.COMMERCIAL_RUNTIME_ALLOWLIST_MANAGE,
            Permissions.DISCOVER_PROVIDER_APPLICATION_VIEW,
            Permissions.DISCOVER_PROVIDER_APPLICATION_REVIEW,
            Permissions.DISCOVER_PROVIDER_APPLICATION_REQUEST_CHANGES,
            Permissions.DISCOVER_PROVIDER_APPLICATION_APPROVE,
            Permissions.DISCOVER_PROVIDER_APPLICATION_PUBLISH,
            Permissions.DISCOVER_PROVIDER_APPLICATION_HISTORY_VIEW,
            Permissions.PLATFORM_PROVIDER_CONNECTION_VIEW,
            Permissions.PLATFORM_PROVIDER_CONNECTION_PROPOSE,
            Permissions.PLATFORM_PROVIDER_CONNECTION_APPROVE,
            Permissions.PLATFORM_PROVIDER_CONNECTION_REJECT,
