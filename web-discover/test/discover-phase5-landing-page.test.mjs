...
test("phase 5 landing page builder routes and preview are wired", () => {
  ...
  assert.ok(renderer.includes("landing-public-url-row"));
  ...
  assert.ok(renderer.includes("landing-hours-table__hours"));
  assert.ok(renderer.includes("landing-hours-table__closed"));
  assert.ok(renderer.includes("Contact methods"));
  ...
  assert.ok(styles.includes(".landing-contact-grid"));
  assert.ok(styles.includes(".landing-contact-card--wide"));
  assert.ok(styles.includes(".landing-public-url-row"));
  assert.ok(styles.includes(".landing-hours-table"));
