# Commercial Platform Specification Track

Commercial Platform work is split into ordered batches:

1. S1 Catalog Foundation
...
- S4.1 Effective Entitlements UX Polish
- S4.2 Override Management
- S4.3 Runtime Diff Dashboard

Commercial runtime remains disabled by default until an explicit cutover is approved.
